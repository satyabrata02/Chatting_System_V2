        ...
        <div class="container">
            ...
            <form method="post" action="registration_con.jsp">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        <input type="text" name="phoneno" maxlength="10" onKeyPress="return numbersonly(event)" autocomplete="off" id="phoneno" required>
                    ...
                    <div class="select-menu">
                        <input type="radio" name="secure_question" id="ops-1" value="what is your nick name ?" required>
