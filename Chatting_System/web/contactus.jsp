...
<head>
    ...
    <link rel="stylesheet" href="css/contactus_about.css">
</head>
<body>
    <nav>
        <div class="nav-bar">
...
<!--  Header End -->
    ...
    <div class="contactus">
        <div class="container">
            ...
            <form method="post" action="contactus_con.jsp">
                <div class="form-row">
                    <div class="input-data">
                        <input type="text" name="firstname" id="firstname" maxlength="25" pattern="[A-Za-z\s]*$" autocomplete="off" required>
                        <div class="underline"></div>
                        <label for="">First Name</label>
                        <span id="error" class="error"></span>
                    </div>
                    <div class="input-data">
                        <input type="text" name="lastname" id="lastname" maxlength="25" pattern="[A-Za-z]+$" autocomplete="off" required>
                        <div class="underline"></div>
                ...
                <div class="form-row">
                    <div class="input-data">
                        <input type="text" name="phoneno" minlength="10" maxlength="10" onKeyPress="return numbersonly(event)"  autocomplete="off" id="phoneno" required>
                        <div class="underline"></div>
                        <label for="phno">Phone Number</label>
                        <span id="error3" class="error"></span>
                    </div>
                    <div class="input-data">
                        <input type="email" name="emailid" id="emailid" maxlength="35" autocomplete="off" required>
                        <div class="underline"></div>
                ...
                <div class="form-row">
                    <div class="input-data textarea">
                        <textarea name="messages" cols="30" rows="10" id="messages" required></textarea>
                        <div class="underline"></div>
            ...
            <%
                ...
                if(message == "inserted"){
                    out.println("<SCRIPT LANGUAGE='JavaScript'>alert('Thank you for your concern.\\nOur team will soon contact you.')</SCRIPT>");
                }
            %>
        </div>
    </div>
    ...
    <script src="js/contactus_validation.js"></script>
</body>
</html>